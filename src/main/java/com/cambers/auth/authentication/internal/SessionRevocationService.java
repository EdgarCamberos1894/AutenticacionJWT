...
class SessionRevocationService {
    ...
    @Transactional void revokeOwnedSession(UUID accountId, UUID sessionId, SessionRevocationReason reason) {
    ...
    @Transactional void revokeAllForUser(UUID accountId, SessionRevocationReason reason) {
    ...
    @Transactional void revokeCompromisedSession(UUID sessionId) {
