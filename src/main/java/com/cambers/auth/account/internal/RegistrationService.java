...
public class RegistrationService implements AccountRegistration {
    ...
    private EmailAlreadyRegisteredException alreadyRegistered() {
        auditPublisher.now(SecurityAuditEvent.of(SecurityAuditAction.REGISTRATION, SecurityAuditOutcome.FAILURE,
                SecurityAuditReason.ACCOUNT_ALREADY_EXISTS, null, null));
